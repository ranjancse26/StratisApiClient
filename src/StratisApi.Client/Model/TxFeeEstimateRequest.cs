...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TxFeeEstimateRequest :  IEquatable<TxFeeEstimateRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TxFeeEstimateRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TxFeeEstimateRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TxFeeEstimateRequest" /> class.
        /// </summary>
        ...
        public TxFeeEstimateRequest(string walletName = default(string), string accountName = default(string), List<OutpointRequest> outpoints = default(List<OutpointRequest>), List<RecipientModel> recipients = default(List<RecipientModel>), string opReturnData = default(string), string opReturnAmount = default(string), string feeType = default(string), bool? allowUnconfirmed = default(bool?), bool? shuffleOutputs = default(bool?), string changeAddress = default(string))
        {
            ...
            if (walletName == null)
            {
                throw new InvalidDataException("walletName is a required property for TxFeeEstimateRequest and cannot be null");
            }
            else
            {
            ...
            if (recipients == null)
            {
                throw new InvalidDataException("recipients is a required property for TxFeeEstimateRequest and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as TxFeeEstimateRequest);
        }

        /// <summary>
        /// Returns true if TxFeeEstimateRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of TxFeeEstimateRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TxFeeEstimateRequest input)
        {
            if (input == null)
                return false;
