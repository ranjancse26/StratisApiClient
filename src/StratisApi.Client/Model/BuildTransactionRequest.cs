...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BuildTransactionRequest :  IEquatable<BuildTransactionRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BuildTransactionRequest" /> class.
        /// </summary>
        ...
        public BuildTransactionRequest(string feeAmount = default(string), string password = default(string), string walletName = default(string), string accountName = default(string), List<OutpointRequest> outpoints = default(List<OutpointRequest>), List<RecipientModel> recipients = default(List<RecipientModel>), string opReturnData = default(string), string opReturnAmount = default(string), string feeType = default(string), bool? allowUnconfirmed = default(bool?), bool? shuffleOutputs = default(bool?), string changeAddress = default(string))
        {
            ...
            if (walletName == null)
            {
                throw new InvalidDataException("walletName is a required property for BuildTransactionRequest and cannot be null");
            }
            else
            {
            ...
            if (recipients == null)
            {
                throw new InvalidDataException("recipients is a required property for BuildTransactionRequest and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as BuildTransactionRequest);
        }

        /// <summary>
        /// Returns true if BuildTransactionRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of BuildTransactionRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BuildTransactionRequest input)
        {
            if (input == null)
                return false;
