...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ScTxFeeEstimateRequest :  IEquatable<ScTxFeeEstimateRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ScTxFeeEstimateRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ScTxFeeEstimateRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ScTxFeeEstimateRequest" /> class.
        /// </summary>
        ...
        public ScTxFeeEstimateRequest(string sender = default(string), string walletName = default(string), string accountName = default(string), List<OutpointRequest> outpoints = default(List<OutpointRequest>), List<RecipientModel> recipients = default(List<RecipientModel>), string opReturnData = default(string), string opReturnAmount = default(string), string feeType = default(string), bool? allowUnconfirmed = default(bool?), bool? shuffleOutputs = default(bool?), string changeAddress = default(string))
        {
            ...
            if (walletName == null)
            {
                throw new InvalidDataException("walletName is a required property for ScTxFeeEstimateRequest and cannot be null");
            }
            else
            {
            ...
            if (recipients == null)
            {
                throw new InvalidDataException("recipients is a required property for ScTxFeeEstimateRequest and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as ScTxFeeEstimateRequest);
        }

        /// <summary>
        /// Returns true if ScTxFeeEstimateRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ScTxFeeEstimateRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ScTxFeeEstimateRequest input)
        {
            if (input == null)
                return false;
